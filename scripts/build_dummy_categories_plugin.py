"""Build the Asset Categories Community Plugin API-test fixture."""
...
PLUGIN_ROOT = ROOT / "plugins" / "dummy-categories"
...
def build(output: Path) -> Path:
    ...
    component = output.parent / "asset-categories.wasm"
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=PLUGIN_ROOT / "dist" / "asset-categories.openpdm-plugin",
    )
